...
// //   useEffect(() => {
// //     setIsClient(true); // Fix hydration error
// //   }, []);
...
// //       setPendingAmount(pendingResponse?.pendingAmount || 0); // Ensure it's a valid number
// //       setPaymentHistory(historyResponse?.paymentHistory || []); // Ensure it's an array
// //     } catch (error) {
...
//   async function fetchLoanDetails() {
//     try {
//       console.log("Fetching loan status for Loan ID:", loanId);
//       const loanStatus = await getLoanStatus(loanId);
//       const historyResponse = await getPaymentHistory(loanId);

//       console.log("Loan Status Response:", loanStatus);
//       console.log("Payment History Response:", historyResponse);

//       if (loanStatus?.success) {
//         setPendingAmount(parseFloat(loanStatus.pendingAmount) || 0);
//         setRemainingLoan(parseFloat(loanStatus.remainingLoan) || 0);
//       } else {
//         setPendingAmount(0);
//         setRemainingLoan(0);
//       }
...
//           {/* {isClient && remainingLoan !== null && (
//             <p className="text-yellow-300 text-lg font-semibold">
//               Remaining Loan Balance: ${remainingLoan.toLocaleString()}
//             </p>
//           )} */}
